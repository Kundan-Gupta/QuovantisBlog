...
function understrap_posted_on() {
	...
	if(!is_single()){
		...
		echo '<span class="byline ' . $cat_name . '"><span class="posted-by">By</span>' . $byline . '</span><span class="posted-on"> / ' . $posted_on . '</span>';
	}else{
		echo '<span class="byline ' . $cat_name . '"><span class="posted-by">By</span>' . $byline . '</span><span class="posted-on"> On ' . $posted_on . '</span>';
	}
